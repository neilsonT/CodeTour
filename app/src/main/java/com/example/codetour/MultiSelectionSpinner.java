/* MultiSelectionSpinner class 를 위한 파일
*  설명 : 중복선택이 가능한 spinner class이다.
*  내용 : MultiSelectionSpinner과 관련된 메소드들이 정의되어있다.
*  오리지날 Spinner에 있는 메소드들을 재정의 해놓은거같다.. 이 많은 메소드들이 정확히 다 무슨일을 하는지는 아직..잘..
*
* */
