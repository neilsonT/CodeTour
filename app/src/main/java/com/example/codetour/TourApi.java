...
/*
    public void getexplainUrl(Spot spot) {
    ...
    public class GetDataAsyncTask extends AsyncTask<String, Void, List<Spot>> {
        ...
        protected List<Spot> doInBackground(String... strings) {    //url 연결, Json Data 받아온 후 파싱.
            ...
            for (int i = 0; i < spotList.size(); i++) {
                System.out.println("list1:" + spotList.get(i).getTitle());
            }
 ...
 */
    ...
    /*
    public class GetExplainAsyntaskTask extends AsyncTask<String, Void, String> {
